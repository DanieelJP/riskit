  ...
  <ion-page>
    <div class="pingpong-container">
      ...
      <div class="main-content">
        ...
        <h1 class="page-title">Ping Pong Tournament</h1>

        <!-- Evento especial -->
        <section class="special-event">
          <div class="event-card">
            <img src="/pingpongT.png" alt="Ping Pong Tournament" class="event-image" />
        ...
        <section class="description-section">
          <p class="event-description">
            Vocational training students will have a sports day with individual ping pong matches, featuring 15 players. The final is planned between the teachers and DAW students.
