  ...
  <ion-page>
    <div class="pokemon-container">
      ...
      <div class="main-content">
        ...
        <h1 class="page-title">Pokémon Tournament</h1>

        <!-- Evento especial -->
        <section class="special-event">
          <div class="event-card">
            <img src="/pokemonT.png" alt="Pokemon Tournament" class="event-image" />
        ...
        <section class="description-section">
          <p class="event-description">
            Vocational training students will have a sports day with a Pokémon tournament, where 15 participants will face off in individual battles. The final will be between the best trainers: the teachers and the DAW students.
